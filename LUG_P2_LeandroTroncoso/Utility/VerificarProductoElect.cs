...
namespace Utility
{
    public class VerificarProductoElect : Verificador
    {
        public bool CheckForm(TextBox codigo,TextBox descripcion,TextBox marca,TextBox precioUnitario,TextBox cantidad)
        {
